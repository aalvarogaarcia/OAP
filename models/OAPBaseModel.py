...
class OAPBaseModel(OAPStatsMixin):
    ...
    def extract_subspace_facets(
        self, var_prefixes: str | list[str] | None = None, verbose: bool = False
    ...
    def extract_facets(
        self, var_prefixes: str | list[str] | None = None, verbose: bool = False
    ) -> tuple[list[str], list[list[float]], set[Any]]:
        """
    ...
    def log_facets(
        self,
        filepath: str,
        var_prefixes: str | list[str] | None = None,
        verbose: bool = False,
        freenames: list[str] | None = None,
        facets: list[list[float]] | None = None,
        lin_set: set[Any] | None = None,
    ) -> None:
        """
        ...
        for i, row in enumerate(rows):
            ...
            facets_data.append({"equation_str": ecuacion_completa, "sense": signo, "rhs": b, "components": coefs_dict})

        # --- GUARDADO EN ARCHIVO JSONL ---
        log_entry = {"iteration": iteracion_actual, "num_facets": len(facets_data), "facets": facets_data}
