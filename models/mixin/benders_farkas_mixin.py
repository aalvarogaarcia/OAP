        ...
        for i, j in self.x.keys():
            ...
            for k, l in self.x.keys():
                ...
                self.constrs_y["r3"][key] = self.sub_y.addConstr(
                    gp.quicksum(self.y[t] for t in tris) + gp.quicksum(self.y[t] for t in tris_kl) <= 1,
                ...
                self.constrs_yp["r3_p"][key] = self.sub_yp.addConstr(
                    gp.quicksum(self.yp[t] for t in tris) + gp.quicksum(self.yp[t] for t in tris_kl) <= 1,
