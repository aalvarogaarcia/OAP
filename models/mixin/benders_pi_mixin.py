...
class BendersPiMixin:
    ...
    def build_pi_subproblems(self, sum_constrain: bool = True, strengthen: bool = False, plot_strengthen: bool = False) -> None:
    ...
    def _crear_variables_strengthening_pi(self) -> None:
        ...
        r3_keys = [
            ...
            if (i, j) != (k, l)
            and ((i, j), (k, l)) in crossing_pairs
            and self.triangles_adj_list[k][l]
        ]
    ...
    def _add_strengthening_pi(self, plot: bool = False) -> None:
        ...
        for key in getattr(self, '_r3_keys', []):
            ...
            self.constrs_y['r3'][key] = self.sub_y.addConstr(
                ...
                + art_r3_p_y[key] - art_r3_n_y[key] <= 1,
            ...
            self.constrs_yp['r3_p'][key] = self.sub_yp.addConstr(
                ...
                + art_r3_p_yp[key] - art_r3_n_yp[key] <= 1,
